      ...
      <section>
        <div className="about-me">
          ...
          <p className="text">
            ...
            and .NET to create robust APIs for web applications. In addition to
            my expertise in frontend and backend development, I am also familiar
            with several databases such as MongoDB, Firebase, and MSSQL which I
